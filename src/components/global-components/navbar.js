		...
		<div>
			...
			<div className="ltn__header-top-area section-bg-6 top-area-color-white---">
				...
				<div className="row" >
					...
					<div className="ltn__top-bar-menu">
						<ul>
						<li><a href="mailto:contact@abidienterprises.com?Subject=Construction%20inquiry"><i className="icon-mail" /> contact@abidienterprises.com</a></li>
						<li><a href="tel:+923004807720"><i class="fa-solid fa-phone"></i> 0300 4807720</a></li>
						<li><i className="icon-placeholder" /> Plaza No.22, Block­ Y, Phase-3, DHA, Lahore, Pakistan</li>
						<li><Social /></li>
						</ul>
					</div>
					</div>
			...
			<div className="ltn__header-middle-area ltn__header-sticky ltn__sticky-bg-white">
				...
				<div className="row align-items-center">
					...
					<div className="site-logo-wrap">
						<div className="site-logo go-top logo">
						<Link to="/"><img src={publicUrl+"assets/img/AElogo.png"} alt="Logo" /></Link>
						</div>
					...
					{/* header-search-1 */}
					<div  className="col-lg-9 col-6 ltn__header-options ltn__header-options-2 mb-sm-20">
					...
					{/* mini-cart */}
					{/* Mobile Menu Button */}
					<div className="mobile-menu-toggle d-xl-none text-end">
					
					{this.state.isMenuOpen ? <a onClick={this.close} href="#ltn__utilize-mobile-menu" >
						...
						<a onClick={this.open} href="#ltn__utilize-mobile-menu" className="ltn__utilize-toggle" >
						<svg viewBox="0 0 800 600">
							<path d="M300,220 C300,220 520,220 540,220 C740,220 640,540 520,420 C440,340 300,200 300,200" id="top" />
							<path d="M300,320 L540,320" id="middle" />
							<path d="M300,210 C300,210 520,210 540,210 C740,210 640,530 520,410 C440,330 300,190 300,190" id="bottom" transform="translate(480, 320) scale(1, -1) translate(-480, -318) " />
			...
			<div id="ltn__utilize-mobile-menu" className="ltn__utilize ltn__utilize-mobile-menu">
				<div className="ltn__utilize-menu-inner ltn__scrollbar">
					...
					<button onClick={this.close} className="ltn__utilize-close">×</button>
					</div>
					...
					<ul>
						<li><a href="https://www.facebook.com/AbidiEnterprises" title="Facebook"><i className="fab fa-facebook-f" /></a></li>
						{/* <li><a href="#" title="Twitter"><i className="fab fa-twitter" /></a></li>
						<li><a href="#" title="Linkedin"><i className="fab fa-linkedin" /></a></li> */}
						<li><a href="https://www.instagram.com/abidienterprises/" title="Instagram"><i className="fab fa-instagram" /></a></li>
					</ul>
					</div>
				</div>
			</div>
